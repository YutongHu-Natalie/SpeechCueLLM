...
def get_few_shot_examples(dataset):
    ...
    Examples now use JSON format to encourage structured output and prevent verbose responses.
    """
    if dataset == 'iemocap':
        examples = [
            {
    ...
    for conv_id in all_conv_id:
        ...
        for conv_turn in range(len(sentence_dict[conv_id])):
            ...
            if experiments_setting == 'few_shot':
                ...
                if audio_only == 'True':
                    temp_content_str += f'Based on the audio features, select one emotion from [{label_text_set[dataset]}]. Output your answer in the following JSON format:\n{{"detected_emotion_label": "ONE_WORD_EMOTION_ONLY", "reason": "brief explanation"}}\nIMPORTANT: The detected_emotion_label field must contain ONLY one emotion word from the list above, without any additional text or explanation.'
                elif audio_description == 'True' or audio_impression == 'True':
                    temp_content_str += f'For {target_utterance}, based on the context and audio features, select one emotion from [{label_text_set[dataset]}]. Output your answer in the following JSON format:\n{{"detected_emotion_label": "ONE_WORD_EMOTION_ONLY", "reason": "brief explanation"}}\nIMPORTANT: The detected_emotion_label field must contain ONLY one emotion word from the list above, without any additional text or explanation.'
                else:
                    temp_content_str += f'For {target_utterance}, based on the context, select one emotion from [{label_text_set[dataset]}]. Output your answer in the following JSON format:\n{{"detected_emotion_label": "ONE_WORD_EMOTION_ONLY", "reason": "brief explanation"}}\nIMPORTANT: The detected_emotion_label field must contain ONLY one emotion word from the list above, without any additional text or explanation.:'

            elif experiments_setting == 'zero_shot':
                # Zero-shot: Direct and clear JSON instruction without examples
                if audio_only == 'True':
                    temp_content_str += f'\n\nBased on the audio features, select one emotion from [{label_text_set[dataset]}]. Output your answer in the following JSON format:\n{{"detected_emotion_label": "ONE_WORD_EMOTION_ONLY", "reason": "brief explanation"}}\nIMPORTANT: The detected_emotion_label field must contain ONLY one emotion word from the list above, without any additional text or explanation.:'
                elif audio_description == 'True' or audio_impression == 'True':
                    temp_content_str += f'\n\nFor {target_utterance}, based on the context and audio features, select one emotion from [{label_text_set[dataset]}]. Output your answer in the following JSON format:\n{{"detected_emotion_label": "ONE_WORD_EMOTION_ONLY", "reason": "brief explanation"}}\nIMPORTANT: The detected_emotion_label field must contain ONLY one emotion word from the list above, without any additional text or explanation.:'
                else:
                    temp_content_str += f'\n\nFor {target_utterance}, based on the context, select one emotion from [{label_text_set[dataset]}]. Output your answer in the following JSON format:\n{{"detected_emotion_label": "ONE_WORD_EMOTION_ONLY", "reason": "brief explanation"}}\nIMPORTANT: The detected_emotion_label field must contain ONLY one emotion word from the list above, without any additional text or explanation.:'
